...
function MyList(content:Lists) {
  ...
  return (
       ...
       <div className="flex-1  text-gray-800 flex-wrap justify-start"> 
        <div className="bg-white text-black flex-1 max-w-[300px] px-2 pb-2">
            ...
            <div className="gap-2 bg-blue-300 rounded-lg p-3">
               ...
               <div className="bg-blue-400 flex flex-row gap-2"> <AiFillLike />{Fast.Items[0].Likes}</div>
               <div className="bg-blue-400 flex flex-row gap-2"> <FaComments /></div>
                </div>
            </div>
        </div>
